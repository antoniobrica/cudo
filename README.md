...
Run `nx serve my-app` for a dev server. Navigate to http://192.168.29.131:4200/. The app will automatically reload if you change any of the source files.
...
## To Run Ory Kratos
Change 192.168.29.131 to 'your-local-ip' in following files 1: apps\mf-container-app\src\app\config\kratos.tsx
