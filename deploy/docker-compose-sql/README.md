...
/opt/mssql-tools/bin/sqlcmd -S 192.168.0.31 -U sa -P 'Welcome@1'
...
root@df2561f10b5c:/# /opt/mssql-tools/bin/sqlcmd -S 192.168.0.31 -U sa -P 'Welcome@1'
1>
...
If, however, you are running this locally on either Windows or Mac, we need to obtain the ip address. Generally, 192.168.0.31 will work fine, however when I was testing on windows, I had to run ipconfig on windows.
