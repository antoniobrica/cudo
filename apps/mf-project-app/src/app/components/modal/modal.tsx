...
type CreateProjectResult = {
  createProject: {
    id: string;
    // other properties of the createProject result
  };
};
export function ModalExampleModal(props: ProjectInfoProps) {
  ...
  React.useEffect(() => {
    if (printingCompanyData) {
      setPrintingCompany(
        printingCompanyData.company.map(({ companyName }) => ({
          key: companyName,
          value: companyName,
          text: companyName,
        }))
  ...
  const onprojectClient = (event, data) => {
    ...
    if (data.value == 'click') {
      return (
        <div>
          <ModalExampleCompany></ModalExampleCompany>
          <br />
        </div>
      );
    }
  ...
  const handleSaveProject = () => {
    ...
    addProject({
      ...
      update: (cache, result) => {
        ...
        if ('createProject' in result.data) {
          cache.writeQuery({
            query: GET_PROJECTS,
            data: {
              getProjects: [...cacheData.projects, result.data.createProject],
            },
          });
        }
        console.log('data==', result);
            ...
            <Grid columns={2}>
              <Grid.Row>
                <Grid.Column>
                  <Form.Field>
                    <label>
                      What's the Project Name? <span className="danger">*</span>
                    </label>
                    <Input
                      placeholder="Default"
                      size="small"
                ...
                <Grid.Column>
                  <Form.Field>
                    <label>
                      Internal Project Number <span className="danger">*</span>
                    </label>
                    <Input
                      placeholder="Default"
                      size="small"
            ...
            <Grid columns={2}>
              <Grid.Row>
                <Grid.Column>
                  <Form.Field>
                    <label>
                      Client <span className="danger">*</span>
                    </label>
                    <Select
                      placeholder="Select"
                      className="small"
                ...
                <Grid.Column>
                  <Form.Field>
                    <label>
                      Type of building <span className="danger">*</span>
                    </label>
                    <Select
                      placeholder="Select"
                      className="small"
              ...
              <Grid.Row>
                <Grid.Column>
                  <Form.Field>
                    ...
                    <TextArea placeholder="Tell us more" value={description} onChange={onDescription} />
                  </Form.Field>
                </Grid.Column>
              </Grid.Row>
            </Grid>
  ...
  return (
    <div id="navbar">
      ...
      >
        ...
        <Modal onClose={() => setSecondOpen(false)} open={secondOpen} size="small">
          ...
          <Modal.Content body>
            <div>
                ...
                <Grid columns={1}>
                  <Grid.Row>
                    <Grid.Column>
                      <Form.Field>
                        <label>
                          What's the Company name? <span className="danger">*</span>
                        </label>
              ...
              <Button content="Add Company" onClick={() => setOpen(false)} positive size="mini" className="grey-btn" />
        ...
        <Modal.Actions>
          <Button content="Click to continue" onClick={handleSaveProject} positive size="mini" className="grey-btn" />
          <Button size="mini" className="icon-border" onClick={() => setOpen(false)}>
            X Cancel
          </Button>
        </Modal.Actions>
