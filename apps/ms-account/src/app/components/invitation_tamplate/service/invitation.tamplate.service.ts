...
export class InvitationTemplateService {
  ...
  public async createInvitationTemplate(
  ...
  public async updateInvitationTemplate(
  ...
  public async deleteInvitationTemplateByID(
    DeleteInput: UpdateInvitationTemplate
  ): Promise<InvitationTemplateEntity[]> {
