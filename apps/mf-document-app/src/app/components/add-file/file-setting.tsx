    ...
    addFile({
      ...
      update: (cache, result) => {
        ...
        cache.writeQuery({
          query: GET_FILES,
          data: {
            tasks: [...cacheData.File, result.data?.createFile],
          },
        });
      },
    });
  ...
  return (
    <div>
      ...
      >
              ...
              <Grid columns={3}>
                <Grid.Row>
                  <Grid.Column>
                    ...
                    <Form.Field>
                      <a className="anchor-color" onClick={folderOpen}>
                        + Add New
                      </a>
                    </Form.Field>
                  </Grid.Column>
        ...
        <Modal.Actions>
          <Button content="Submit" onClick={handleSaveFile} positive size="mini" className="grey-btn" />
