...
context('Cypress.env()', () => {
  ...
  it('Get environment variables', () => {
    ...
    Cypress.env({
      ...
      api_server: 'http://192.168.29.131:8888/v1/',
    });
    ...
    Cypress.env('api_server', 'http://192.168.29.131:8888/v2/');
    expect(Cypress.env('api_server')).to.eq('http://192.168.29.131:8888/v2/');

    // get all environment variable
    expect(Cypress.env()).to.have.property('host', 'veronica.dev.local');
    expect(Cypress.env()).to.have.property(
      'api_server',
      'http://192.168.29.131:8888/v2/'
    );
  });
});
