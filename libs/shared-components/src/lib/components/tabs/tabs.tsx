          ...
          <div className="ui-tabs">
            ...
            <div className="text-center margin-top">
              ...
              <p className="project-sub" style={{ color: '#9A9EA1' }}>
                Hey User, you don't have any active sub project lists on this project. Click the button <br /> below to
                create a sub project list.
              </p>
            </div>
          </div>
        </Tab.Pane>
                    ...
                    <Card className="ui_width">
                      <div className="ui card ui_width">
                        <div className="content paddingcontent">
                          ...
                          <div className="header font-header ">High priority things</div>
                        ...
                        <div className="content noborder">
                          <div className="data-built data_area">
                            <p>
                              This is description will be show sunt in culpa qui officia deserunt mollit anim id est
                              laborum...
                            </p>
                          </div>
                    ...
                    <Card className="ui_width">
                      <div className="ui card ui_width">
                        <div className="content paddingcontent">
                          ...
                          <div className="header font-header paddingarea">High priority things</div>
                          <div className="description">John & co. +2 others responsible</div>
                        </div>
      ...
      render: () => (
        <Tab.Pane attached={false}>
          <div className="ui-tabs">
            ...
            <span className="sessiontext" style={{ display: 'flex' }}>
              Please manage the cost for Electrical Work
                ...
                <Grid.Row>
                  <Grid.Column>
                    <Form.Field className="fillarea" style={{ display: 'flex' }}>
                      <img src={`${MS_SERVICE_URL['ASSETS_CDN_URL'].url}/assets/images/money.png`}></img>{' '}
                      <label style={{ marginLeft: '10px' }}>Estimated Cost</label>
                    </Form.Field>
                  </Grid.Column>
                  <Grid.Column>
