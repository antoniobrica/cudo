...
import { Button, Select, Modal, Input, Form, Grid, Dropdown, TextArea, Dimmer, Loader } from 'semantic-ui-react';
...
export function ModalAddInvitation(props: AddInvitationProps) {
  ...
  const validation = () => {
    const errorResponse: AddInvitationErrors = {};
  ...
  return (
    <div id="navbar">
      <Modal
        className={`modal_media right-side--fixed-modal add-new-invitation-modal${loader && ' overflow-hidden'}`}
        closeIcon
      ...
      >
                ...
                <Grid.Row>
                  <Grid.Column>
                    <Form.Field>
                      ...
                      />
                      {errors?.titleError && !invitationTitle ? (
              ...
              <Grid columns={3}>
                <Grid.Row>
                  ...
                  <Grid.Column>
                    <Form.Field>
                      <label>
                        Start time <span className="danger">*</span>
                      </label>
                      <Input
                        placeholder="Default"
                        size="small"
                      ...
                      />
                      {errors?.startTimeError && !meetingStartTime ? (
                        <span className="error-message">{errors.startTimeError}</span>
                      ) : null}
                    </Form.Field>
                  </Grid.Column>
                  <Grid.Column>
                    <Form.Field>
                      <label>
                        End time <span className="danger">*</span>
                      </label>
                      <Input
                        placeholder="Default"
                        size="small"
                      ...
                      />
                      {errors?.endTimeError && !meetingEndTime ? (
                        <span className="error-message">{errors.endTimeError}</span>
                      ) : null}
                      {errors?.startEndTimeError ? (
                        <span className="error-message">{errors.startEndTimeError}</span>
                      ) : null}
                    </Form.Field>
                  </Grid.Column>
                </Grid.Row>
              ...
              <Grid columns={1}>
                <Grid.Row>
                  <Grid.Column>
                    <Form.Field>
                      <label>
                        Members<span className="danger">*</span>
                      </label>
                      <MembersIndex
                        members={[]}
                        parentMembersSelect={onMembers}
                        error={errors?.membersError && !members.length}
                      />
                      {errors?.membersError && !members.length ? (
                        <span className="error-message">{errors.membersError}</span>
                      ) : null}
                    </Form.Field>
                  </Grid.Column>
                </Grid.Row>
        ...
        <Modal.Actions>
          <Button content="Submit" onClick={createInvitation} positive size="small" className="primary" />
          <Button
            size="small"
