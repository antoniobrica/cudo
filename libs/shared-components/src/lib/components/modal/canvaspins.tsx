...
export function CanvasPins(props: CanvasPinsProps) {
  ...
  const pinFetchFilter = props?.parentWisePinFetch === true ? {
...
// '--props?.parentFileId--', props?.parentFileId, '--props.fileId--', props.fileId)
  ...
  const drawFillCircle = (info, style = {}) => {
    ...
    if (!info.isNewPin)
      ctxToDrawCircle.fillStyle = info.isHovering ? info.hovercolor : (info.isCompleted ? info.completedcolor : info.blurcolor); // Red color   
    else
