...
export function ProjectSetting(props: TabsProps) {
  const level1Panels = [{ key: 'panel-1a', title: '1st floor', content: 'Create & edit tasks' }];
                  ...
                  <div className="ui card" style={{ width: '100%' }}>
                            ...
                            <Grid.Row>
                              ...
                              <Grid.Column>
                                <Form.Field className="field_left">
                                  ...
                                  <span style={{ color: '#2D62ED' }}>
                                    <br /> Estimate Cost: $5,000.00 - Total Cost: $5,000.00{' '}
                                  </span>
                                </Form.Field>
                              </Grid.Column>
                              <Grid.Column>
                                <Form.Field>
                                  <span className="summary">
                                    <button className="ui mini button edit_btn">
                                      {' '}
                                      <img src={img5} /> Edit
                                    </button>
                                  </span>{' '}
                      ...
                      <Table celled className="default_table">
                        ...
                        <Table.Body>
                          <Table.Row>
                            ...
                            <Table.Cell>8090</Table.Cell>
                            <Table.Cell>Switzerland</Table.Cell>
                            <Table.Cell> Müller Ltd, Mr R. Bürki Zollikerstrasse 788 8008 Zurich</Table.Cell>
                          </Table.Row>
                        </Table.Body>
                      </Table>
                    </div>
                    <div className="content" style={{ borderTop: 'none' }}>
                      <div className="data-built">
                        <p>
                          {' '}
                          The building utilizes wrapped glass facades on the east, north, and west both for aesthetics
                          and to reduce the amount of reflective surface area on the south facade, which also features
                          brushed Jura limestone.{' '}
                        </p>
                      </div>
                      <div>
                        <br />
        ...
        <Tab.Pane attached={false}>
          <div className="ui-tabs">
            <div className="ui card " style={{ width: '80%' }}>
              <Accordion className="widtharea" defaultActiveIndex={0} panels={rootPanels} styled></Accordion>
            </div>
            <div className="ui card " style={{ width: '80%' }}>
              <Accordion className="widtharea" defaultActiveIndex={0} panels={rootPanels} styled></Accordion>
            </div>

            <button style={{ width: '80%' }} className="ui large button btn-dashed  btn-large">
              <i className="ms-Icon ms-Icon--AddTo" aria-hidden="true"></i> Add Top Level{' '}
            </button>
          </div>
        </Tab.Pane>
      ),
              ...
              <div className="content" style={{ borderTop: 'none' }}>
                <div className="data-built">
                  <p>
                    ...
                    <span className="mr-10 ">Pos.1 </span> <span className="mr-10 ">Internal Project Number</span>{' '}
                  </p>
                  ...
                  <p>
                    ...
                    <span className="mr-10 ">Pos.6</span> <span className="mr-10 ">Phase Number</span>{' '}
                  </p>
                  ...
                  <p>
                    ...
                    <span className="mr-10 ">Pos.7</span> <span className="mr-10 ">Type of Building </span>{' '}
                  </p>
                  ...
                  <p>
                    ...
                    <span className="mr-10 ">Pos.8</span> <span className="mr-10 ">Sub-project Number</span>{' '}
                  </p>
                  ...
                  <p>
                    ...
                    <span className="mr-10 ">Pos.10</span> <span className="mr-10 ">Level of the building</span>{' '}
                  </p>
                  ...
                  <p>
                    ...
                    <span className="mr-10 ">Pos.11</span> <span className="mr-10 ">Document Type</span>{' '}
                  </p>
                  ...
                  <p>
                    ...
                    <span className="mr-10 ">Pos.12 </span>{' '}
                    <span className="mr-10 ">Increment value for the Document</span>{' '}
                  </p>
                </div>
              </div>
            </div>
