                ...
                <div className="ui card">
                  <div className="content">
                    ...
                    <div className="data-built">
                      Type of building
                      <span className="summary">Residential Buildings</span>
                    </div>

                    <div className="data-built">
                      Level of building
                      <span className="summary">3rd</span>
                    </div>
                  </div>
                  <div className="content">
                    <div className="data-built">
                  ...
                  <div className="content">
                    <div className="data-built">
                      <p>
                        {' '}
                        This is description will be show sunt in culpa qui officia deserunt mollit anim id est
                        laborum...This is description will be show sunt in culpa qui officia deserunt mollit anim id est
                        laborum qui officia deserunt mollit anim id est laborum...This is description will be show sunt
