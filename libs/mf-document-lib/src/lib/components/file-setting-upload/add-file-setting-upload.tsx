...
export function AddFileSettingUpload(props: any) {
      ...
      .pipe(
        tap((items) => {
          ...
          for (let i = 0; i < items.length; i++) {
            fileArr.push({
              fileURL: items[i].filename,
              fileTitle: items[i].filename,
  ...
  const handleSaveFile = () => {
    ...
    files.map((file, i) => {
      addFile({
        ...
        update: (cache, addedFileDatadata) => {
  ...
  return (
    <div id=" " className="add-files-modal">
      ...
      <Modal
        className="modal_media modal_center add-file-setting-popup"
        closeIcon
        size="small"
        onClose={cancel}
        onOpen={() => setOpen(true)}
        ...
        trigger={
          <Button size="small" className="primary">
            <i className="ms-Icon ms-font-xl ms-Icon--Add"></i> {t('project_tab_menu.add_file')}
          </Button>
        }
        closeOnDimmerClick={false}
      >
        <Modal.Header>
          <h3>{t('project_tab_menu.add_file')}</h3>
        </Modal.Header>
        <Modal.Content body>
          <div>
            <Form>
                            ...
                            <div className="radio">
                              <label>
                                <input
                                  ...
                                  checked={accessPeople ? false : true}
                                />
                            ...
                            <div className="radio">
                              <label>
                                <input
                                  ...
                                  checked={accessPeople ? true : false}
                                />
