...
export interface FilePinDetailsProps {
  isOpen
  cancel
  taskData
}

export function FilePinDetails(props: FilePinDetailsProps) {
  ...
  return (
    <div>
      ...
      <AddPinFile
        ...
        cancel={props.cancel}
        savePin={savePins}
        // dowloadFilesData={downloadFiles}
      />
    </div>
  );
}

export default FilePinDetails;
